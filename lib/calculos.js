...
export function calcKPIs(pecas, lancamentos, btsConfig, filtroAndar='todos') {
  ...
  // Volume real concretado = soma de volumes lançados nas BTs
  const concVol = lancamentos.reduce((s,l)=>s+l.volume, 0);
  ...
  // Volume real faltando = projeto - real concretado (BTs)
